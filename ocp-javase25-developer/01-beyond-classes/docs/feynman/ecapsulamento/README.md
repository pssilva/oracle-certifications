...
Aplicando o protocolo Feynman de 60 minutos especificamente para o CONCEITO: Ecapsulamento! E usar os áudios e cards para aplicar a [técnica revisão espaçada](https://youtu.be/XG0CAM_VYdE?si=-YqvN01n5A44NIGC).


## Escolha o Assunto (0-2 min)

CONCEITO: Ecapsulamento
...
» » Encapsulando Dados com Registros
...
E tire uma foto de evidência e coloque na pasta: `/home/pssilva/projetos/oracle-certifications/ocp-javase25-developer/01-beyond-classes/docs/feynman/ecapsulamento/evidencias`

<img src="evidencias/imgs/evidencia-encapsulamentos-records-4em1.jpeg" alt="Conceito: Operador" title="Operador" style="width:250px;"/>
