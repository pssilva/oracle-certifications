...
Aplicando o protocolo Feynman de 60 minutos especificamente para o CONCEITO: Polimorfismo! E usar os áudios e cards para aplicar a [técnica revisão espaçada](https://youtu.be/XG0CAM_VYdE?si=-YqvN01n5A44NIGC).
...
E tire uma foto de evidência e coloque na pasta: `/home/pssilva/projetos/oracle-certifications/ocp-javase25-developer/01-beyond-classes/docs/feynman/polimorfismo/evidencias`

<img src="evidencias/imgs/evidencia-heranca-polimorfismo-3em1.jpeg.jpeg" alt="Conceito: Herança, Polimorfismo" title="Herança e Polimorfismo" style="width:250px;"/>
