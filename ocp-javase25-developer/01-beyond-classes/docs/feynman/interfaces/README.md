...
Aplicando o protocolo Feynman de 60 minutos especificamente para o CONCEITO: Interfaces! E usar os áudios e cards para aplicar a [técnica revisão espaçada](https://youtu.be/XG0CAM_VYdE?si=-YqvN01n5A44NIGC).
...
E tire uma foto de evidência e coloque na pasta: `/home/pssilva/projetos/oracle-certifications/ocp-javase25-developer/01-beyond-classes/docs/feynman/interfaces/evidencias`

<img src="evidencias/imgs/evidencia-interface-membros-4em1.jpeg" alt="Conceito: Interfaces" title="Interfaces" style="width:250px;"/>

---

<img src="evidencias/imgs/evidencia-interface-modificadores-4em1.jpeg" alt="Conceito: Interfaces" title="Interfaces" style="width:250px;"/>
