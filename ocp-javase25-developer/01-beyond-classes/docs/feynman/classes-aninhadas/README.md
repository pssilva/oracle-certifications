...
Aplicando o protocolo Feynman de 60 minutos especificamente para o CONCEITO: Classes Aninhadas! E usar os áudios e cards para aplicar a [técnica revisão espaçada](https://youtu.be/XG0CAM_VYdE?si=-YqvN01n5A44NIGC).


## Escolha o Assunto (0-2 min)

CONCEITO: Classes Aninhadas
...
E tire uma foto de evidência e coloque na pasta: `/home/pssilva/projetos/oracle-certifications/ocp-javase25-developer/01-beyond-classes/docs/feynman/classes-aninhadas/evidencias`

<img src="evidencias/imgs/evidencia-classe-aninhada-interna.jpeg" alt="Conceito: Classes Aninhadas" title="Classes Aninhadas" style="width:250px;"/>

---

<img src="evidencias/imgs/evidencia-classe-aninhada.jpeg" alt="Conceito: Classes Aninhadas" title="Classes Aninhadas" style="width:250px;"/>
