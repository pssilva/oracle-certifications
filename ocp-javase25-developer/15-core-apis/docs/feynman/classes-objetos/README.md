...
Aplicando o protocolo Feynman de 60 minutos especificamente para o CONCEITO: Classes / Objetos! E usar os áudios e cards para aplicar a [técnica revisão espaçada](https://youtu.be/XG0CAM_VYdE?si=-YqvN01n5A44NIGC).
...
» » Compreendendo a Estrutura de Classes
...
<img src="evidencias/imgs/evidencia-classes-objetos-4em1.jpeg" alt="Conceito: Elementos Principais, Regras Arquivo-Fonte, Métodos main()" title="Elementos Principais, Regras Arquivo-Fonte, Métodos main()" style="width:250px;"/>
...
E tire uma foto de evidência e coloque na pasta: `/home/pssilva/projetos/oracle-certifications/ocp-javase25-developer/15-core-apis/docs/feynman/classes-objetos/evidencias`
