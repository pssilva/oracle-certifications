...
Aplicando o protocolo Feynman de 60 minutos especificamente para o CONCEITO: Interfaces Funcional! E usar os áudios e cards para aplicar a [técnica revisão espaçada](https://youtu.be/XG0CAM_VYdE?si=-YqvN01n5A44NIGC).


## Escolha o Assunto (0-2 min)

CONCEITO: Interfaces Funcional
...
OCP Oracle Certified Professional Java SE 21 Developer
 ...
 » » Codificando Interfaces Funcionais
```
...
E tire uma foto de evidência e coloque na pasta: `/home/pssilva/projetos/oracle-certifications/ocp-javase25-developer/06-lambdas-functional-interfaces/docs/feynman/interfaces-funcional/evidencias`

<img src="evidencias/imgs/evidencia-interface-funcional-2em1.jpeg" alt="Conceito: Interfaces Funcional" title="Interfaces Funcional" style="width:250px;"/>
