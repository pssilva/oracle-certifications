...
Aplicando o protocolo Feynman de 60 minutos especificamente para o CONCEITO: Herança! E usar os áudios e cards para aplicar a [técnica revisão espaçada](https://youtu.be/XG0CAM_VYdE?si=-YqvN01n5A44NIGC).
...
E tire uma foto de evidência e coloque na pasta: `/home/pssilva/projetos/oracle-certifications/ocp-javase25-developer/01-class-design/docs/feynman/herança/evidencias`

<img src="evidencias/imgs/evidencia-heranca-metodos-privados-4em1.jpeg" alt="Conceito: Herança" title="Herança" style="width:250px;"/>

---


<img src="evidencias/imgs/evidencia-heranca-object-4em1.jpeg" alt="Conceito: Herança" title="Herança" style="width:250px;"/>
